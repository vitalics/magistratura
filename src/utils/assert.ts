...
export function assertEqual<T1 extends Object & Record<string, unknown>, T2 extends Object & Record<string, unknown>>(obj1: T1, obj2: T2) {
    const isObjectEqual = isEqual(obj1, obj2);
    assert(isObjectEqual, 'compared objects are not equals')
}

function isEqual<T1 extends Object & Record<string, unknown>, T2 extends Object & Record<string, unknown>>(object1: T1, object2: T2) {
